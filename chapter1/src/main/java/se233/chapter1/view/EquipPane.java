...
public class EquipPane extends ScrollPane
{
    ...
    private Pane getDetailsPane()
    {
        ...
        unEquipped.setText("Un-Equip Item");
        unEquipped.setOnAction(new AllCustomHandler.UnEquipItemHandler());

        equipmentInfoPane.getChildren().addAll(weaponLbl,weaponImgGroup,armorLbl,armorImgGroup,unEquipped);
